...
//
//
//Constructor will initialize object and it will give default values to all uninitialize variables(global);
//
//
//String/Object - null
//boolean - false
...
//
//If you create a constructor --> COMPILER WILL NOT CREATE ANY DEFAULT CONSTRUCTOR
//
//The main purpose of CONSTRUCTOR is to initialize instance variables
//
//We cannot make a constructor as static
//When we make a private constructor, we can instantiate the class within itself, but won't b able to instantiate it in different classes
//
//- - - - - - - - - - - - - - - - - - -
//
...
//
//4- Constructor is getting called AUTOMATICALLY, whereas methods needs to be called.
//
//5- If we don't define a constructor --> compiler will create 1 default for you, whereas for methods compiler WON't create it.
//
//
//SIMILARITY
//
