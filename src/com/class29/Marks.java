...
//(each out of 100) by student A and in four subjects (each out of 100) by student
//B. Create class ‘Marks’ with an abstract method ‘getPercentage’. It is inherited
//by classes ‘A’ and ‘B’ each having a method with the same name which returns the
