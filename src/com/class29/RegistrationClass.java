...
//3. Create Registration Class in which you would have variables as email, userName and 
//password that have an access scope only within its own class. After creating an object 
//of the class user should be able to call methods and in each method separately pass values 
