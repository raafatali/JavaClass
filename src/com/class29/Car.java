...
//has its own implementation of  calculateSalePrice() method in which returned price 
//calculated as following: if weight>2000 then returned ar price should include
